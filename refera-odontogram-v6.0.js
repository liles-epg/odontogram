...
`;
  ...
  function addDefs() {
    ...
    defs.append(grad, hoverShadow, selectedShadow);
    svg.append(defs);
  }
  ...
  function initialize() {
    ...
    if (!mount || mount.dataset.odontogramReady === "v6.0") return false;

    mount.dataset.odontogramReady = "v6.0";
